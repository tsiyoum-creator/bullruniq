// BullrunIQ — shared server utilities (auth, plan lookup, response helpers).
...
function verifyToken(tok) {
  try {
    ...
    const eBuf = Buffer.from(expect, "utf8");
...
module.exports = { secretKey, verifyToken, signToken, planFor, json };
