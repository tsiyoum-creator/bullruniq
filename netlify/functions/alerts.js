...
const { esc, unsubUrl } = require("./_shared");
...
const CGMAP = {
  ...
  LINK:"chainlink", LTC:"litecoin", BCH:"bitcoin-cash", ETC:"ethereum-classic", XMR:"monero",
  DASH:"dash", ZEC:"zcash",
  // Mid-caps
  NEAR:"near", APT:"aptos", SHIB:"shiba-inu", UNI:"uniswap", ATOM:"cosmos", TRX:"tron",
  ...
  QNT:"quant-network", ALGO:"algorand", VET:"vechain", FIL:"filecoin", ICP:"internet-computer",
  RENDER:"render-token", FTM:"fantom", CRO:"crypto-com-chain",
  // DeFi
  LDO:"lido-dao", RUNE:"thorchain", AAVE:"aave", MKR:"maker", CRV:"curve-dao-token",
  COMP:"compound-governance-token", SNX:"synthetix-network-token", YFI:"yearn-finance",
  BAL:"balancer", "1INCH":"1inch", PENDLE:"pendle", GRT:"the-graph", CAKE:"pancakeswap-token",
  AERO:"aerodrome-finance",
  // Gaming / Metaverse
  SAND:"the-sandbox", MANA:"decentraland", AXS:"axie-infinity", GALA:"gala",
  IMX:"immutable-x", BEAM:"beam-2",
  // Memes & new
  BLUR:"blur", FLOKI:"floki", BONK:"bonk", WLD:"worldcoin-wld", POPCAT:"popcat",
  NOT:"notcoin", MEW:"cat-in-a-dogs-world",
  // AI / infra
  FET:"fetch-ai", AGIX:"singularitynet", TAO:"bittensor",
  // Solana ecosystem
  JUP:"jupiter-exchange-solana", PYTH:"pyth-network", JTO:"jito-governance-token",
  // L2 / ZK
  STRK:"starknet", ZK:"zksync", SEI:"sei-network", TIA:"celestia",
  // Liquid staking / restaking
  ETHFI:"ether-fi", ENA:"ethena",
  // Other
  ONDO:"ondo-finance", KAVA:"kava", ZETA:"zetachain",
};
