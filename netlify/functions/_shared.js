...
// Functions prefixed with _ are internal; import with require("./_shared").
...
function verifyToken(tok) {
  try {
    ...
    // timingSafeEqual requires equal lengths; mismatched lengths means invalid token
...
module.exports = { secretKey, signToken, verifyToken, planFor, esc, jsonResponse, corsHeaders };
